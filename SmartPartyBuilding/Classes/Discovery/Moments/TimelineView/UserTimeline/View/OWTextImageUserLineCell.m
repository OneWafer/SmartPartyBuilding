...
@interface OWTextImageUserLineCell ()
...
@implementation OWTextImageUserLineCell
...
-(void) updateWithItem:(OWTextImageUserLineItem *) item
{
...
-(CGFloat) getCellHeight:(OWTextImageUserLineItem *) item
{
