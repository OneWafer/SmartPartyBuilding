...
//dataPicker的回调
typedef BOOL(^OWSelectedBlockDate)(BOOL isCancel, NSDate *date);
 ...
 */
typedef BOOL(^OWSelectedBlockNormal)(BOOL isCancel, NSArray<NSString *> *results, NSArray<NSNumber *> *indexs);
 ...
 * DataPicker
 */
@property (nonatomic, copy) OWSelectedBlockNormal selectedBlockNormal;
...
@property (nonatomic, copy) OWSelectedBlockDate selectedBlockDate;
...
+ (instancetype)pickEntity:(id)entity
             ...
             outputKeyPath:(NSString *)outputKeyPath
                   forView:(UIView *)view
             selectedBlock:(OWSelectedBlockNormal)selectedBlock;
