...
@interface OWNavigationController ()<UIGestureRecognizerDelegate>
...
+ (void)initialize
{
    ...
    attrs[NSForegroundColorAttributeName] = wh_norFontColor;
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    if (self.childViewControllers.count > 0) {
        ...
        [backBtn setImage:wh_imageNamed(@"navi_back") forState:UIControlStateNormal];
        [backBtn setTitle:@"返回" forState:UIControlStateNormal];
        [backBtn setTitleColor:wh_norFontColor forState:UIControlStateNormal];
