...
#define H(height) wh_screenHeight*(height)/1136
#define W(width) wh_screenWidth*(width)/640
#define MAXYEAR 2050
#define MINYEAR 1970

@interface OWMtDatePickerView ()<UIPickerViewDelegate,UIPickerViewDataSource>
{
    //日期存储数组
...
@implementation OWMtDatePickerView
...
-(void)setupUI
{
    UIView *contentView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, self.wh_width, self.wh_height)];
    ...
    self.chooseTimeLabel=[[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.dateView.wh_width, H(80))];
    ...
    self.line1=[[UIView alloc] initWithFrame:CGRectMake(0, self.chooseTimeLabel.wh_bottom, self.dateView.wh_width, 1)];
    self.line1.backgroundColor= wh_RGB(237, 237, 237);
    [self.dateView addSubview:self.line1];
    
    [self addLabelTextWithName:@[@"年",@"月",@"日",@"时",@"分"]];
    
    self.line2=[[UIView alloc] initWithFrame:CGRectMake(0, self.yearLabel.wh_bottom, self.dateView.wh_width, 1)];
    self.line2.backgroundColor=wh_RGB(237, 237, 237);
    [self.dateView addSubview:self.line2];
    
    self.line3=[[UIView alloc] initWithFrame:CGRectMake(self.dateView.wh_width*4/7, self.line1.wh_bottom, 1, self.dateView.wh_height-H(160))];
    self.line3.backgroundColor=wh_RGB(237, 237, 237);
    [self.dateView addSubview:self.line3];
    
    self.line4=[[UIView alloc] initWithFrame:CGRectMake(0, self.line3.wh_bottom, self.dateView.wh_width, 1)];
    self.line4.backgroundColor=wh_RGB(237, 237, 237);
    ...
    self.cancelButton.frame=CGRectMake(0, self.line4.wh_bottom, self.dateView.wh_width*4/7, H(80));
    ...
    [self.okButton setTintColor:wh_RGB(217, 17, 22)];
    self.okButton.titleLabel.font=[UIFont systemFontOfSize:14];
    self.okButton.frame=CGRectMake(self.cancelButton.wh_right, self.line4.wh_bottom, self.dateView.wh_width*3/7, H(80));
...
-(void)addLabelWithName:(NSArray *)nameArr {
    for (int i=0; i<nameArr.count; i++) {
        CGFloat labelX;
        if (i<3) {
            labelX= (self.dateView.wh_width/7)*(i+1) + 5*i;
        }else{
            labelX=(self.dateView.wh_width/7)*(i+2) - 9*i;
            if (i == 4) {
                labelX=(self.dateView.wh_width/7)*(i+2) - 20;
            }
        }
        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(labelX+W(40), self.dateView.wh_height/2-15/2.0+20, 15, 15)];
        ...
        UIView *line=[[UIView alloc] initWithFrame:CGRectMake(label.wh_left-lineW, label.wh_bottom, lineW, 1)];
        line.backgroundColor = wh_RGB(217, 17, 22);
...
- (void)addLabelTextWithName:(NSArray *)nameArray{
    ...
    for (int i = 0; i < nameArray.count; i ++) {
        UILabel *label=[[UILabel alloc] initWithFrame:CGRectMake(self.dateView.wh_width*(i+1)/7+9*i, self.line1.wh_bottom, W(40), H(60))];
...
-(UIPickerView *)datePicker {
    if (!_datePicker) {
        _datePicker = [[UIPickerView alloc] initWithFrame:CGRectMake(W(50), self.yearLabel.wh_bottom-20, self.dateView.wh_width-W(100), self.dateView.wh_height-H(170))];
...
+ (CGFloat)getLabelHeightByWidth:(CGFloat)width Title:(NSString *)title font:(UIFont *)font {
    ...
    [label sizeToFit];
    CGFloat height = label.wh_height;
    return height;
}
@end
